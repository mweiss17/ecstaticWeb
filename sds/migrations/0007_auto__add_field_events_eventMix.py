...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Events.eventMix'
        db.add_column(u'sds_events', 'eventMix',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sds.Music']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Events.eventMix'
        db.delete_column(u'sds_events', 'eventMix_id')
