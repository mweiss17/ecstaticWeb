...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Events.url'
        db.alter_column(u'sds_events', 'url', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Events.url'
        db.alter_column(u'sds_events', 'url', self.gf('django.db.models.fields.CharField')(default='null', max_length=100))
