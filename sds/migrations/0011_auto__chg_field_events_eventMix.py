...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Events.eventMix'
        db.alter_column(u'sds_events', 'eventMix_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sds.Music'], null=True))

    def backwards(self, orm):

        # Changing field 'Events.eventMix'
        db.alter_column(u'sds_events', 'eventMix_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sds.Music']))
    ...
    models = {
        ...
        u'sds.events': {
            ...
            'eventMix': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sds.Music']", 'null': 'True'}),
