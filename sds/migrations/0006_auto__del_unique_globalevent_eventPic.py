...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'globalEvent', fields ['eventPic']
        db.delete_unique(u'sds_globalevent', ['eventPic_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'globalEvent', fields ['eventPic']
        db.create_unique(u'sds_globalevent', ['eventPic_id'])
