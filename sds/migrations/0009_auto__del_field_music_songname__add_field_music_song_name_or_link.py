...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Music.song_name_or_link'
        db.add_column(u'sds_music', 'song_name_or_link',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'sds_music', 'songname',
                      self.gf('django.db.models.fields.CharField')(default='rick astley', max_length=255),
                      keep_default=False)

        # Deleting field 'Music.song_name_or_link'
        db.delete_column(u'sds_music', 'song_name_or_link')
