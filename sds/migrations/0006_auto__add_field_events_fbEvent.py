...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Events.fbEvent'
        db.add_column(u'sds_events', 'fbEvent',
                      self.gf('django.db.models.fields.URLField')(default='https://www.facebook.com/SilentDiscoSquad', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Events.fbEvent'
        db.delete_column(u'sds_events', 'fbEvent')
