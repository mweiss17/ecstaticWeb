...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Events.arrive_start_time'
        db.add_column(u'sds_events', 'arrive_start_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 6, 4, 0, 0)),
                      keep_default=False)

        # Adding field 'Events.music_start_time'
        db.add_column(u'sds_events', 'music_start_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 6, 4, 0, 0)),
                      keep_default=False)

        # Adding field 'globalEvent.arrive_start_time'
        db.add_column(u'sds_globalevent', 'arrive_start_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 6, 4, 0, 0)),
                      keep_default=False)

        # Adding field 'globalEvent.music_start_time'
        db.add_column(u'sds_globalevent', 'music_start_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 6, 4, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Events.arrive_start_time'
        db.delete_column(u'sds_events', 'arrive_start_time')

        # Deleting field 'Events.music_start_time'
        db.delete_column(u'sds_events', 'music_start_time')

        # Deleting field 'globalEvent.arrive_start_time'
        db.delete_column(u'sds_globalevent', 'arrive_start_time')

        # Deleting field 'globalEvent.music_start_time'
        db.delete_column(u'sds_globalevent', 'music_start_time')
