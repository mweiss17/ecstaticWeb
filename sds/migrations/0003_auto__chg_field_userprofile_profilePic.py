...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.profilePic'
        db.alter_column(u'sds_userprofile', 'profilePic_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sds.ProfilePicture']))

    def backwards(self, orm):

        # Changing field 'UserProfile.profilePic'
        db.alter_column(u'sds_userprofile', 'profilePic_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sds.Photos']))
    ...
    models = {
        ...
        u'sds.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'profilePic': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sds.ProfilePicture']"}),
