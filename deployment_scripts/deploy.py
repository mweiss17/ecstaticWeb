...
def create_autoscaling_group():
    ...
    init_script = "#!/bin/bash sed -i 's/preprod.cdadlb7rfieo.us-east-1.rds.amazonaws.com/sdslivejan28.cdadlb7rfieo.us-east-1.rds.amazonaws.com/g ~/sds/sds/config.json"
